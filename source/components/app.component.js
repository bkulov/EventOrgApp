System.register(['angular2/core', 'angular2/router', '../services/speakers.service', './agenda.component', '../services/lectures.service', './lectures.component', './speakers.component', './lecture-detail.component', './speaker-detail.component', './login-main.component', './loggedin-o365.component', '../services/office365.service', '../services/google.service', './login-facebook.component', '../services/facebook.service', '../services/twitter.service', './login-twitter.component'], function(exports_1, context_1) {
    ...
    return {
        setters:[
            ...
            function (login_facebook_component_1_1) {
                login_facebook_component_1 = login_facebook_component_1_1;
            },
            ...
            function (login_twitter_component_1_1) {
                login_twitter_component_1 = login_twitter_component_1_1;
            }],
        execute: function() {
            EventApp = (function () {
                function EventApp() {
                    ...
                    router_1.RouteConfig([
                        {
                            ...
                            path: '/loginTwitter',
                            name: 'LoginTwitter',
                            component: login_twitter_component_1.LoginTwitterComponent
                        }
                    ]),
                    core_1.Component({
                        selector: 'event-app',
                        template: "\n\t\t<button (click)=\"goBack()\">back</button>\n\t\t<nav>\n\t\t\t<a [routerLink]=\"['Agenda']\">Agenda</a>\n\t\t\t<a [routerLink]=\"['Lectures']\">Lectures</a>\n\t\t\t<a [routerLink]=\"['Speakers']\">Speakers</a>\n\t\t</nav>\n\t\t<router-outlet></router-outlet>\n\t",
                        providers: [speakers_service_1.SpeakersService, lectures_service_1.LecturesService, router_1.ROUTER_PROVIDERS, office365_service_1.Office365Service, google_service_1.GoogleService, facebook_service_1.FacebookService, twitter_service_1.TwitterService],
