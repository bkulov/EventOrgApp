System.register(['angular2/core', './services/office365.service'], function(exports_1) {
    ...
    var core_1, office365_service_1;
    ...
    return {
        ...
        execute: function() {
            LoginMainComponent = (function () {
                function LoginMainComponent(_office365Service) {
                ...
                LoginMainComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [office365_service_1.Office365Service])
                ], LoginMainComponent);
