System.register(['../../jspm_packages/npm/angular2@2.0.0-beta.9/core', './utils.service'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            let Office365Service = class Office365Service {
                ...
                login() {
                    var aa = this._utilsService.loadJSON('/O365_id.json', ((content) => {
                        var o365Config = JSON.parse(content);
                        window.location.href = o365Config.url;
                    }));
                }
                setLoginData(code, sessionState) {
                    this.code = code;
